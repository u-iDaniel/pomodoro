export default function PrivacyPage() {
  return (
    <div className="bg-black bg-opacity-5 p-8 rounded-lg text-white shadow-lg max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-4">Privacy Policy</h1>
      <p className="mb-4 text-gray-300">Last updated: July 16, 2025</p>
      ...
      <p className="mb-4">We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" className="text-blue-400 hover:underline">Privacy Policy Generator</a>.</p>
      ...
      <ul className="mb-4 space-y-2">
        ...
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to pomoAI.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to pomoAI, accessible from <a href="https://pomoai.tech" rel="external nofollow noopener" target="_blank" className="text-blue-400 hover:underline">https://pomoai.tech</a></p>
        </li>
        <li>
      ...
      <h3 className="text-xl font-bold mt-4 mb-2">Delete Your Personal Data</h3>
      ...
      <h4 className="text-lg font-bold mt-4 mb-2">Business Transactions</h4>
      ...
      <h4 className="text-lg font-bold mt-4 mb-2">Law enforcement</h4>
      ...
      <h4 className="text-lg font-bold mt-4 mb-2">Other legal requirements</h4>
      ...
      <ul className="mb-4 space-y-2">
      <li>By email: codemonkeyhacked@gmail.com</li>
      </ul>
    </div>
  );
}